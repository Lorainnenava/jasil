    ...
    <div className="portafolio">
      ...
      <div className="sobremi" id="sobremi">
        <h5 className="aboutme">
          Sobre mi
          <hr />
          Soy Jasil Flórez tengo 20 años soy de Barranquilla, soy una persona
          muy divertida,tambien soy puntual en mi trabajo me gusta aprender cada
          dia mas,especializado en front-end
        </h5>
